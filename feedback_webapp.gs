...
function doGet(e) {
  ...
  // Modo escrita: registra um voto vindo do dashboard/e-mail
  sheet.appendRow([
    new Date(),
    params.id || '',
    params.title || '',
  ...
  var emoji = params.vote === 'like' ? '👍' : '👎';
  var html = '<html><body style="font-family: -apple-system, sans-serif; text-align: center; padding: 60px 20px; color: #1F1E1B;">'
    + '<div style="font-size: 48px;">' + emoji + '</div>'
    + '<p style="font-size: 16px;">Voto registrado, obrigado!</p>'
    + '<p style="font-size: 13px; color: #6B6A63;">Pode fechar esta aba.</p>'
    + '</body></html>';
